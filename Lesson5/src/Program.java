...
public class Program {
    ...
    /**
     * Метод генерации  последовательности случайных символов
     *
    ...
    /**
     * записывает в файл случайную последовательность символов, а так же указанное слово
     * @param fileName имя файла
     * @param length длина последовательности символов
    ...
    /**
     * метод склеивает содержимое двух файлов в новый (третий) файл
     * @param fileIn1 первый файл
     * @param fileIn2 второй файл
     * @param fileOut третий файл (выходной)
     */
    ...
    /**
     * метод поиска указанного слова в файле
     * @param fileName имя файла
    ...
    /**
     * Поиск указанного слова в файлах внутри дериктории и ее поддиректорий
